...
<div id="k2Container" class="itemListPortfolio itemListView<?php if($this->params->get('pageclass_sfx')) echo ' '.$this->params->get('pageclass_sfx'); ?>">
	...
	<div class="itemList">
		...
		<div id="itemListLeading">
			...
			<div class="itemContainer<?php echo $lastContainer; ?> colspan3"<?php echo (count($this->leading)==1) ? '' : ' style="width:'.number_format(100/$this->params->get('num_leading_columns'), 1).'%;"'; ?>>
				<?php
