...
<div id="k2Container" class="itemView<?php echo ($this->item->featured) ? ' itemIsFeatured' : ''; ?><?php if($this->item->params->get('pageclass_sfx')) echo ' '.$this->item->params->get('pageclass_sfx'); ?>">
	...
	<div class="itemHeader">
		...
		<div class="itemHeaderRight">
			...
			<span class="itemDateCreated">
				<?php echo date("Y-m-d", strtotime($this->item->created)); ?>
			</span>
			<?php endif; ?>			
		</div>
		<?php endif; ?>
  ...
  <?php endif; ?>
	...
	<div class="itemSocialSharing">
		...
		<a href="javascript:void((function()%7Bvar%20e=document.createElement(&apos;script&apos;);e.setAttribute(&apos;type&apos;,&apos;text/javascript&apos;);e.setAttribute(&apos;charset&apos;,&apos;UTF-8&apos;);e.setAttribute(&apos;src&apos;,&apos;http://assets.pinterest.com/js/pinmarklet.js?r=&apos;+Math.random()*99999999);document.body.appendChild(e)%7D)());"><img src="<?php JURI::base(true) ?>templates/jf_calla-exteriors/images/pinterest64.png" alt="share on pinterest" /></a>
		...
		<a href="http://society6.com" target="_blank" title="Follow on Society6"><img src="<?php JURI::base(true) ?>templates/jf_calla-exteriors/images/soceity664.png" alt="share on soceity6" /></a>
		</div>
	  ...
	  <ul class="itemCommentsList">
	    ...
	    <li class="<?php echo ($key%2) ? "odd" : "even"; echo (!$this->item->created_by_alias && $comment->userID==$this->item->created_by) ? " authorResponse" : ""; echo($comment->published) ? '':' unpublishedComment'; ?>">
		    ...
		    <span class="commentAuthorName">
			    <span><?php echo JText::_('K2_POSTED_BY'); ?></span>
  ...
  <!-- Related items by tag -->
	<div class="itemRelated">
		...
		<ul>
			...
			<li class="<?php echo ($key%2) ? "odd" : "even"; ?> <?php echo ($key%3==2) ? "last" : ""; ?>">
