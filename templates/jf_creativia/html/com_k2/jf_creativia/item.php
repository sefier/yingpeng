...
<div id="k2Container" class="itemView<?php echo ($this->item->featured) ? ' itemIsFeatured' : ''; ?><?php if($this->item->params->get('pageclass_sfx')) echo ' '.$this->item->params->get('pageclass_sfx'); ?>">
  ...
  <div class="itemBody">
	...
	<div class="itemDateModifiedBlock">
		<div class="pull-left"><?php echo JText::_('K2_LAST_MODIFIED_ON'); ?></div>
  ...
  <div class="itemLinks">
		...
		<div class="itemCategory">
			<div class="pull-left"><?php echo JText::_('K2_PUBLISHED_IN'); ?></div>
	  ...
	  <div class="itemTagsBlock">
		  <div class="pull-left"><?php echo JText::_('K2_TAGGED_UNDER'); ?></div>
		  <ul class="itemTags">
			<?php
	  ...
	  <div class="itemAttachmentsBlock">
		  <div class="pull-left"><span><?php echo JText::_('K2_DOWNLOAD_ATTACHMENTS'); ?></span></div>
  ...
  <!-- Related items by tag -->
	<div class="itemRelated">
		<div class="pull-left"><?php echo JText::_("K2_RELATED_ITEMS_BY_TAG"); ?></div>
		<ul>
 ...
 <?php if($this->item->params->get('itemComments') && ($this->item->params->get('comments') == '1' || ($this->item->params->get('comments') == '2')) && empty($this->item->event->K2CommentsBlock)): ?>
  ...
  <div class="itemComments">
	<h3 class="itemCommentsTitle"><?php echo JText::_('K2_COMMENTS'); ?></h3>
	  ...
	  <!-- Item user comments -->
	  <p class="itemCommentsCounter">
	  	<span>showing <?php echo $this->item->numOfComments; ?></span> <?php echo ($this->item->numOfComments>1) ? JText::_('K2_COMMENTS') : JText::_('K2_COMMENT'); ?>
	  </p>
	  ...
	  <ul class="itemCommentsList">
	    ...
	    <li class="<?php echo ($key%2) ? "odd" : "even"; echo (!$this->item->created_by_alias && $comment->userID==$this->item->created_by) ? " authorResponse" : ""; echo($comment->published) ? '':' unpublishedComment'; ?>">
			...
			<span class="commentDate">
		    	<?php echo 'on ' . JHTML::_('date', $comment->commentDate, JText::_('K2_DATE_FORMAT_LC2')); ?>
		    </span>
