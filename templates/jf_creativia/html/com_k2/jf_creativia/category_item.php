...
<div class="element <?php echo $this->item->category->name; ?> <?php echo $xclass ?>"  data-category="<?php echo $this->item->category->name; ?>">
		...
		<div class="catItemImageBlock">
		  <span class="catItemImage">
		    <a href="<?php echo $this->item->link; ?>" title="<?php if(!empty($this->item->image_caption)) echo K2HelperUtilities::cleanHtml($this->item->image_caption); else echo K2HelperUtilities::cleanHtml($this->item->title); ?>">
		    	<img src="<?php if(!empty($this->item->image)) echo $this->item->image; else echo JURI::root() . 'templates/jf_creativia/images/k2-without-image.jpg'; ?>" alt="<?php if(!empty($this->item->image_caption)) echo K2HelperUtilities::cleanHtml($this->item->image_caption); else echo K2HelperUtilities::cleanHtml($this->item->title); ?>" style="width:<?php echo $this->item->imageWidth; ?>px; height:auto;" />
		    </a>
		  </span>
		  <div class="clr"></div>
	  </div>
	...
	<?php if($this->item->params->get('catItemRating') || $this->item->params->get('catItemCommentsAnchor')): ?>
	...
	<div class="catItemCommentsLink">
		...
		<?php else: ?>
			...
			<a class="numOfComments" href="<?php echo $this->item->link; ?>#itemCommentsAnchor">
