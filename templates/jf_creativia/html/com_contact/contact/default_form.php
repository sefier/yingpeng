	...
	<form id="contact-form" action="<?php echo JRoute::_('index.php'); ?>" method="post" class="form-validate form-horizontal">
		<fieldset>	
			<?php
				...
				$latitude           = (float)$templateparams->get( 'latitude', '' );
				$longitude          = (float)$templateparams->get( 'longitude', '' );
				$markerdescription  = $templateparams->get('markerdescription', '');
			?>
			<?php if($templateparams->get('map')) : ?>
			...
			<script type="text/javascript">
				...
				function initialize()
				{
					...
					<?php if ($templateparams->get('marker')) : ?>
					marker.setMap(map);
					<?php endif; ?>
			...
			<?php foreach ($this->form->getFieldsets() as $fieldset) : ?>
				...
				<?php endif ?>
			<?php endforeach;?>
			<div class="control-group"><?php echo JText::_('COM_CONTACT_FORM_LABEL'); ?></div>
